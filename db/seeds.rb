...
Safari.create!([
  {
    ...
    location: "Tanzania",
    short_description: "Witness the great wildebeest migration in the vast Serengeti National Park.",
    long_description: "Embark on an unforgettable journey to witness the stunning landscapes and diverse wildlife of the Serengeti. Prepare for a once-in-a-lifetime experience to witness the epic wildebeest migration, guided by our expert trackers and naturalists. Marvel at the vast golden savannah plains stretching to the horizon, dotted with iconic acacia trees and bustling with life. Keep your camera ready to capture sightings of majestic lions, elegant giraffes, and elusive leopards in their natural habitat.\n\nDon't miss your chance to immerse yourself in the timeless beauty of the African wilderness, where every moment is a breathtaking adventure. Secure your spot for the Serengeti Adventure today and discover the wonders of one of Africa's most iconic national parks.",
    price: 3500,
    duration: 7,
    img: "serengeti-cover.png"
  },
  {
    name: "Okavango Delta Discovery",
    location: "Botswana",
    short_description: "Explore the unique waterways and lush islands of the Okavango Delta.",
    long_description: "Immerse yourself in the beauty of the Okavango Delta, known for its picturesque waterways and abundant wildlife. Prepare for an adventure of a lifetime with mokoro rides, game walks, and breathtaking sunsets. Navigate the maze of channels lined with papyrus reeds, encountering hippos, crocodiles, and colorful birdlife. Witness the seasonal floodwaters transform the landscape, creating a haven for wildlife and a paradise for photographers. Experience the magic of gliding silently through crystal-clear waters, surrounded by the sights and sounds of Africa's pristine wilderness.\n\nDon't miss your chance to explore the Okavango Delta. Book your Delta Discovery today!",
    price: 4200,
    duration: 8,
    img: "okavango-cover.png"
  },
  {
    name: "Namib Desert Expedition",
    location: "Namibia",
    short_description: "Experience the mesmerizing landscapes of the world's oldest desert.",
  ...
  },
  {
    ...
    location: "Kenya",
    short_description: "Witness the abundance of wildlife in the iconic Maasai Mara Reserve.",
    long_description: "Join expert guides on a safari in the Maasai Mara, home to the Big Five and the annual wildebeest migration. Enjoy game drives, cultural interactions with the Maasai people, and stunning views of the savannah. Experience the thrill of tracking lions on the hunt, spotting elusive cheetahs in the grasslands, and witnessing herds of elephants bathing in the rivers. Immerse yourself in the rich biodiversity of the Mara, where every day brings new encounters and unforgettable moments.\n\nDon't miss your chance to witness the abundance of wildlife in the Maasai Mara. Book your safari today!",
    price: 4000,
    duration: 7,
  ...
  },
  {
    ...
    location: "Botswana",
    short_description: "Explore the vast salt pans and encounter unique desert-adapted wildlife.",
    long_description: "Venture into the expansive Makgadikgadi Pans and discover the stark beauty of the salt flats. Experience quad biking, cultural encounters with local communities, and witness the unique desert-adapted wildlife. Trek across the shimmering salt pans, where the horizon stretches endlessly in every direction, creating an otherworldly landscape. Encounter desert-adapted species such as meerkats, springbok, and brown hyenas, as they navigate the harsh desert environment. Discover ancient archaeological sites and fossilized remains, offering glimpses into the region's rich history and prehistoric past.\n\nEmbark on an expedition to the Makgadikgadi Pans and uncover its mysteries. Book now!",
    price: 4000,
    duration: 7,
...
p "Created #{Safari.count} safaris"